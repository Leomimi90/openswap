...
const { registerValidationRules, validate } = require('../Middlewares/validationMiddleware');
...
router.post('/users/register', registerValidationRules(), validate, UserController.register);
