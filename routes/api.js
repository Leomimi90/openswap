...
const { loginValidationRules, validate } = require('../Middlewares/validationMiddleware');
...
router.post('/users/register', loginValidationRules(), validate, UserController.register);
